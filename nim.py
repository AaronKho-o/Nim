...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        """
        #print("Starting get_q_value")
        if (tuple(state), action) in self.q:
            return self.q[(tuple(state), action)]
        else:
            return 0
        #print("Finished get_q_value")
    ...
    def best_future_reward(self, state):
        ...
        `state`, return 0.
        """
        #print("Starting best_future_reward")
        best_reward = 0
        ...
        #print("Finishing best_future_reward")
